...
const Alert = (error) => {
    return (
        <div id="alert-border-2" className="flex items-center p-4 mb-4 text-red-800 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800 rounded-full" role="alert">
...
Alert.propTypes = {
    error: errorPropTypes.isRequired
};
